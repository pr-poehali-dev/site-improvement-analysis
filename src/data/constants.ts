...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  ...
  de: {
    ...
    contact_write: "Schreiben Sie uns", contact_call: "+34 656 82 83 48",
    contact_address: "Calle Polonia, 35, San Pedro de Alcántara, 29670 Marbella, Málaga, Spanien",
    contact_hours_title: "Geschäftszeiten",
    contact_hours_1: "Di, Mi & Do: 10:00 – 19:00",
    contact_hours_2: "Fr & Sa: 10:00 – 12:00 und 14:00 – 18:00",
    contact_hours_3: "Sonntag & Montag geschlossen",
    contact_payment: "Wir akzeptieren Bargeld, Kreditkarte und Banküberweisung.",
